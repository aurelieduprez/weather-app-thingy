...
class DetailsCard extends Component {
  render() {
    ...
    let date = dateobject.toLocaleDateString("fr-FR", {
      weekday: "long",
      month: "long",
      year: "numeric",
      day: "numeric",
    ...
    return (
      <div class="p-3">
        ...
        <Card
          style={{ width: "18rem", backgroundColor: "#1C2942", color: "white" }}
        >
          <Card.Body>
            ...
            <Row>
              <Col sm={7}>
                <Card.Img
                  ...
                  src={`http://openweathermap.org/img/wn/${this.props.data.weather[0].icon}@4x.png`}
                />
              </Col>
              <Col sm={5}>
                <br></br>
